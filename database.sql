...
CREATE TABLE queue (id integer primary key autoincrement not null, username text not null, password text not null, date datetime not null default current_timestamp, done boolean not null default 'false');
